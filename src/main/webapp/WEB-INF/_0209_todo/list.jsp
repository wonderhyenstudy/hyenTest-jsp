...
<body>
<h1>list 임시 화면입니다.</h1>
<div><a href="/todo/register_0209">글쓰기 바로가기</a></div>
<br>
...
<div style="margin:10px; padding:10px 30px; border:1px solid #000">
    <h1 style="color:deeppink">로그인한 유저 정보 나타내기 : ${loginInfo.mname}</h1>
    <h1 style="color:#145eff">로그인한 유저 정보 나타내기2 uuid : <span style="font-size: small">${loginInfo.uuid}</span></h1>
