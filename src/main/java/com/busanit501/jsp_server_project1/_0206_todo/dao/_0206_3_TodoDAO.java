...
public class _0206_3_TodoDAO {
    ...
    public String getTime() {
        ...
        try(Connection connection = _0206_9_ConnectionUtil.INSTANCE.getConnection();
            // 현재 시간을 조회하는 쿼리를 전달하고
    ...
    public String getTime2() throws Exception {
        ...
        @Cleanup Connection connection = _0206_9_ConnectionUtil.INSTANCE.getConnection();
        // 현재 시간을 조회하는 쿼리를 전달하고
    ...
    public void insert(_0206_4_TodoVO vo) throws Exception {
        // sql문장 작성,
    ...
    // 목록
    public List<_0206_4_TodoVO> selectAll() throws Exception {
        // sql문장 작성,
        ...
        // 임시로 담아둘 리스트를 선언
        List<_0206_4_TodoVO> list = new ArrayList<>();
...
//     3행   4,샘플제목22,2026-02-03,0
        while(resultSet.next()){
            ...
            _0206_4_TodoVO vo = _0206_4_TodoVO.builder()
    ...
    public _0206_4_TodoVO selectOne(Long tno) throws Exception{
        // sql문장 작성,
    ...
    public void updateOne(_0206_4_TodoVO todoVO) throws Exception {
