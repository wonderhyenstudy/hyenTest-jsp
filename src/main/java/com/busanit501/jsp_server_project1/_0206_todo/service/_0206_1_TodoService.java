...
import com.busanit501.jsp_server_project1._0206_todo.dao._0206_3_TodoDAO;
import com.busanit501.jsp_server_project1._0206_todo.domain._0206_4_TodoVO;
import com.busanit501.jsp_server_project1._0206_todo.dto._0206_2_TodoDTO;
import com.busanit501.jsp_server_project1._0206_todo.util._0206_8_MapperUtil;
...
public enum _0206_1_TodoService {
    ...
    _0206_1_TodoService() {
        // 위에서 전역으로 선언만
        dao = new _0206_3_TodoDAO();
        modelMapper = _0206_8_MapperUtil.INSTANCE.get();
    }
    ...
    // 기능구현,
    // 글쓰기
    public void register(_0206_2_TodoDTO todoDTO) throws Exception {
        // todoDTO -> todoVo 변환
        // "이 VO 안에 들어있는 title, tno 같은 값들을 읽어서,
        // 똑같은 이름을 가진 TodoDTO 객체를 새로 만들어서 채워줘!"라는 뜻입니다.
        _0206_4_TodoVO todoVO = modelMapper.map(todoDTO, _0206_4_TodoVO.class);
...
//        System.out.println("_0204_4_TodoService에서 register 작업중, 변환 결과 확인 todoVO : " + todoVO);
    ...
    // 목록조회
    // 이전 코드
    public List<_0206_2_TodoDTO> getList() {
        // 하드코딩, 더미 데이터로, 10개만 샘플 등록,
        // 반복문으로
        List<_0206_2_TodoDTO> todoDTOS = IntStream.range(0,10).mapToObj(
                i -> {
                    // todo 하나가, todoDTO 객체. 임시 객체 생성해서, 여기에 더미 값을 담기.
                    _0206_2_TodoDTO dto = new _0206_2_TodoDTO();
                    dto.setTno((long)i);
                    dto.setTitle("Todo.." + i);
    ...
    public List<_0206_2_TodoDTO> listAll() throws Exception {
        // 하드코딩, 더미 데이터로, 10개만 샘플 등록,
        List<_0206_4_TodoVO> voList = dao.selectAll();
        ...
        List<_0206_2_TodoDTO> dtoList = voList.stream()
                .map(vo -> modelMapper.map(vo, _0206_2_TodoDTO.class))
    ...
    public _0206_2_TodoDTO get(Long tno) throws Exception {
        //객체 생성
        _0206_2_TodoDTO dto = new _0206_2_TodoDTO();
        // DB로부터 전달 받아서, 사용
        _0206_4_TodoVO todoVO =  dao.selectOne(tno);
        //vo -> dto 타입으로, 모델 맵퍼 이용해서, 변환.
        _0206_2_TodoDTO todoDTO = modelMapper.map(todoVO, _0206_2_TodoDTO.class);
...
//        dto.setFinished(true);
    ...
    //수정하기
    public void modify(_0206_2_TodoDTO todoDTO) throws Exception{
