...
@Log4j2
@WebServlet(name = "_0206_5_TodoReadController", value = "/todo/read_0206")
public class _0206_5_TodoReadController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        // 현재, 작업하는 파일 어디인지, 서버 콘솔에 출력
//        System.out.println("[read] /todo/read_0202, get으로 요청 처리함. ");
        log.info("[read] /todo/read_0206, get으로 요청 처리함. ");
        ...
        try{
            ...
            // 서브스에서 만들었던, get 메서드
            _0206_2_TodoDTO todoDTO = _0206_1_TodoService.INSTANCE.get(tno);
            ...
            // 화면에 전달
            req.getRequestDispatcher("/WEB-INF/_0206_todo/todoRead.jsp").forward(req, resp);
