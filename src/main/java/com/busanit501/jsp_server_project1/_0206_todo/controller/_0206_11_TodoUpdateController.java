...
//        req.setCharacterEncoding("UTF-8");
        ...
        log.info("[updateController] todo/update_0206 수정화면 로직 처리하는 곳입니다.");

        try {

            // 하나 조회했고, 수정화면으로 넘길때, 우리는 조회하는 todo의 tno번호를 알고 있다
            // 하나조회(상세보기), URL : http://localhost:8080/todo/read_0206?tno=24
            ...
            _0206_2_TodoDTO todoDTO = todoService.get(tno);
