...
@WebServlet(name = "_0204_7_TodoListController", value = "/todo/list_0204")
@Log4j2 // 로그를 중요도에 따라서, 기록을 하는 방법을 다르게 한다.
public class _0204_7_TodoListController extends HttpServlet {
...
//        log.info("[TodoListController] : log4j2를 이용해서, 기록하기. ");
        ...
        try{
            ...
            req.getRequestDispatcher("/WEB-INF/_0204_todo/list.jsp").forward(req,resp);
